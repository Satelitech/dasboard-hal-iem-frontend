    ...
    <Stack w={"100%"} h={"100%"} pr={2}>
      ...
      <TableContainer>
        <Table size="sm">
          ...
          <Tbody>
            <Tr>
              <Td>{pwrEnd.nombrePwrEnd}</Td>
              <Td>{pwrEnd.bombaVinculada.info}</Td>
              <Td>{pwrEnd.horasPwrEnd}</Td>
              <Td>{pwrEnd.condicionPwrEnd}</Td>
              <Td>Ubicacion</Td>
              <Td>
                <Select
                  placeholder="- Estado -"
              ...
              <Td>
                {pwrEnd.estado === "montado" && pwrEnd.bombaVinculada.set}
                {pwrEnd.estado !== "montado" && (
                  <Select
        ...
        <Table size="sm">
          ...
          <Tbody>
            <Tr>
              ...
              <Td>{pwrEnd.horasPwrEnd}</Td>
              <Td>{proxService}</Td>
              <Td>{pwrEnd.horasPwrEnd + proxService}</Td>
...
export default DetallePowerEnd;
